...
export function PageWrapper({ children }: PropsWithChildren) {
   ...
   if (!isStepVerified)
      return (
         <div className="flex h-[572px] min-h-[572px] flex-col space-y-4 xs:h-[532px] xs:min-h-[532px]">
   ...
   return (
      <div className="flex h-[572px] min-h-[572px] flex-col xs:h-[532px] xs:min-h-[532px]">
         {children}
      </div>
   );
}
