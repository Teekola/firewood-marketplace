...
const isElement = (element: unknown | undefined): element is ReactElementWithDisplayName => {
   return (element as ReactElementWithDisplayName)?.type?.displayName !== undefined;
};
