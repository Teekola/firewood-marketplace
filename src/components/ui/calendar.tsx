   ...
   return (
      <DayPicker
         ...
         classNames={{
            ...
            head_row: "flex",
            head_cell: "text-foreground-muted rounded-md w-8 font-normal text-[0.8rem]",
            ...
            day_outside:
               "day-outside text-foreground-muted aria-selected:bg-accent/50 aria-selected:text-foreground-muted",
