...
function Calendar({
   ...
   const [currentMonth, setCurrentMonth] = React.useState(selected ? selected : new Date());
   ...
   const _selectedClassName = cn(
      "[&>button]:bg-primary [&>button]:text-primary-foreground [&>button]:hover:bg-primary [&>button]:hover:text-primary-foreground !opacity-100",
   ...
   return (
      <DayPicker
         ...
         // Disabled due to difficulty in fixing the typescript issue.
         // It is certain here that since mode is single, the date value Date is valid
